...
The web app includes three starter themes. Each theme has simple controls for
...
Build with the default Minimal theme:
...
Most custom themes should start as a copy of Minimal, Modern, or Compact. A
theme is one `.typ` file with a JSON manifest at the top:
...
The three starter files under [`themes/`](themes/) are the full examples.
